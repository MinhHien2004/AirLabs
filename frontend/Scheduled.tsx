...
const Scheduled: React.FC = () => {
  ...
  // API URL - Sử dụng relative path để hoạt động cả local và production
  // Khi deploy, React và Spring Boot cùng domain nên chỉ cần /api
  const API_BASE_URL = '';  // Empty string để dùng same-origin
